  ...
  return (
    <div>
      ...
      <div className="flex flex-col mb-20 md:flex-row">
        <div className="flex-col px-10 py-8 border md:px-16 sm:py-16 flex gap-5 text-[15px] hover:bg-primary hover:text-white transition-all duration-300 text-gray-600 cursor-pointer">
          <b>EFFICIENCY:</b>
          <p>
